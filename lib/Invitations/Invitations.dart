...
class _Invitations extends State<Invitations>
    with AutomaticKeepAliveClientMixin<Invitations> {
  @override
    ...
    setState(() {
      if (data_mycampaigns_invitation != null) {
        if ((5 >= data_mycampaigns_invitation.length)) {
          mycampaigns_invitation_items.clear();
          mycampaigns_invitation_items.addAll(data_mycampaigns_invitation);
          mycampaigns_invitation_present = data_mycampaigns_invitation.length;
        } else {
          mycampaigns_invitation_items.clear();
          mycampaigns_invitation_items
              .addAll(data_mycampaigns_invitation.getRange(0, 5));
  ...
  Widget build(BuildContext context) {
    ...
    return data_mycampaigns_invitation != null
        ? Stack(
            children: [
              new ListView.builder(
                  itemCount: (mycampaigns_invitation_present <
                          data_mycampaigns_invitation.length)
                      ? mycampaigns_invitation_items.length + 1
                      : mycampaigns_invitation_items.length,
                  itemBuilder: (BuildContext context, int index) {
                    return ((index == mycampaigns_invitation_items.length) &&
                            (index != data_mycampaigns_invitation.length))
                        ? InkWell(
                            child: Container(
                            ...
                            onTap: () {
                              setState(() {
                                if ((mycampaigns_invitation_present +
                                        mycampaigns_invitation_perPage) >
                                    data_mycampaigns_invitation.length) {
            ...
            child: Column(
              children: [
                ...
                Container(
                  ...
                  child: Text("Belum Ada Campaign Invitation",
                  ...
                  children: [
                    LayoutBuilder(
                      builder: (context, constraint) {
                        if (data_mycampaigns_invitation[index]
                                ['premium_campaign'] ==
                            0) {
                          return Container();
                        } else {
                        ...
                        onTap: () {
                          setState(() {
                            if (data_saved_id.contains(
                                data_mycampaigns_invitation[index]
                                        ['id_campaign']
                                    .toString())) {
                  ...
                  child: Column(
                    children: [
                      Container(
                        ...
                        child: Text(
                          data_mycampaigns_invitation[index]['countdown']
                              .toString(),
                          style:
                          ...
                          children: [
                            Row(
                              ...
                              children: [
                                ...
                                Text(
                                  data_mycampaigns_invitation[index]['price'] !=
                                          null
                                      ? data_mycampaigns_invitation[index]
                                              ['price']
                                          .toString()
                            ...
                            Text(
                              data_mycampaigns_invitation[index]['location']
                                  .toString(),
                              style: TextStyle(
                                  color: kTextThemColor1, fontSize: 12.0),
                            ),
                            Text(
                              data_mycampaigns_invitation[index]['niche']
                                      .toString() +
                                  " - " +
                                  data_mycampaigns_invitation[index]['gender']
                                      .toString(),
                              style: TextStyle(
                                  color: kTextThemColor1, fontSize: 12.0),
                            ),
