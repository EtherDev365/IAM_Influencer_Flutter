...
class _DetailCampaign extends State<DetailCampaign>
  ...
  String submit_content_url =
      "https://web.iam.id/iam-mobile/api/influencer/report/submit-content";
  Future<String> getJsonData_submit_content(
      String url, File feed, File story, String caption) async {
  ...
  String messaage = "";
  String apply_url =
      "https://web.iam.id/iam-mobile/api/influencer/apply/campaign";
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: PreferredSize(
          preferredSize:
              Size.fromHeight(255 - MediaQuery.of(context).padding.top),
          child: AppBar(
            flexibleSpace: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                      image: NetworkImage(
                          data_detail_campaign[0]['logo_campaign']),
                      fit: BoxFit.cover),
                ),
                child: Column(
                  children: [
                                ...
                                onTap: () {
                                  setState(() {
                                    if (data_saved_id.contains(
                                        data_detail_campaign[0]['id_campaign']
                                            .toString())) {
                                      http.post(Uri.encodeFull(delete_url),
                                          headers: {
                                      ...
                                      http.post(Uri.encodeFull(save_url),
                                          headers: {
                                            HttpHeaders.authorizationHeader:
                                                'Bearer $token'
                                          },
                        ...
                        child: Row(
                          children: [
                            ...
                            Column(children: [
                              ...
                              Text(
                                data_detail_campaign[0]['countdown'].toString(),
                                style: TextStyle(
        ...
        floatingActionButton: (open_tab_detail == 0 &&
                status_campaign == "Open" &&
                status_apply == "Belum Apply")
            ? InkWell(
                onTap: () {
            ...
            Container(
              ...
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  colors: [Colors.white, light_grey],
              ...
              child: Column(
                children: [
                  Row(
                    ...
                    children: [
                      Container(
                        ...
                        child: Text(
                          data_detail_campaign[0]['hashtag'] != null
                              ? data_detail_campaign[0]['hashtag'].toString()
                              : "",
                      ...
                      Container(
                          ...
                          child: Text(data_detail_campaign[0]['price'] != null
                              ? data_detail_campaign[0]['price'].toString()
                              : "")),
                    ],
                  ),
                  Container(
                    ...
                    child: Text(
                      data_detail_campaign[0]['campaign_name'] != null
                          ? data_detail_campaign[0]['campaign_name'].toString()
                          : "",
                  ...
                  Container(
                    ...
                    margin: EdgeInsets.only(left: 25, top: 20),
                    child: Text(
                      data_detail_campaign[0]['location'] != null
                          ? data_detail_campaign[0]['location'].toString()
                          : "",
                  ...
                  Container(
                    ...
                    child: Text(
                      data_detail_campaign[0]['niche'] != null
                          ? data_detail_campaign[0]['niche'].toString()
                          : "",
                      style: TextStyle(fontSize: 12, color: Colors.black45),
                    ),
                  ),
                  ...
                  Row(
                    ...
                    children: [
                      Container(
                        ...
                        child: Text(
                          data_detail_campaign[0]['status_campaign'] != null
                              ? data_detail_campaign[0]['status_campaign']
                                  .toString()
                              : "",
                          style: TextStyle(
                            color: pink_red,
                      ...
                      Container(
                          ...
                          child: Text(
                            status_apply,
                            style: TextStyle(
                              color: status_apply == "Menunggu Persetujuan"
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    ...
                    alignment: Alignment.centerLeft,
                    child: Text(
                      data_detail_campaign[0]['influencer_criteria'],
                      style: TextStyle(
                  ...
                  Container(
                    margin: EdgeInsets.only(
                        left: 25, top: 15, right: 25, bottom: 25),
                    alignment: Alignment.centerLeft,
                    child: Text(
                      data_detail_campaign[0]['direction'],
                      style: TextStyle(
                          fontSize: 13, height: 1.5, color: Colors.black54),
                    ),
                  ),
          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                child: Text(
                  "Apakah kamu yakin ingin mendaftar pada campaign ini?",
                ...
                InkWell(
                  ...
                  child: Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          borderRadius: BorderRadius.circular(30),
                          color: knavigationSelectedLabelColor),
                      child: Center(
                        child: Text("Cancel",
                            style: TextStyle(
                                color: Colors.white,
                ...
                InkWell(
                  onTap: () async {
                    await http.post(Uri.encodeFull(apply_url), body: {
                      "id_campaign": detail_campaign_id.toString()
                    }, headers: {
                      HttpHeaders.authorizationHeader: 'Bearer $token'
                    }).then((response) async {
                      if (response.statusCode == 200) {
                        ...
                        if (convertDataToJson['status'] == 0) {
                          ...
                          await http.post(Uri.encodeFull(detailcampaign_url),
                              body: {
                                "id_campaign": detail_campaign_id.toString()
                              },
                              headers: {
                          ...
                          setState(() {
                            status_apply = data_detail_campaign[0]
                                    ['status_apply']
                                .toString();
                          });
                          Navigator.of(context).pop();
            ...
            child: Container(
              child: Column(
                children: [
                  ...
                  Text(
                      status_apply == "Ditolak"
                          ? "Anda tidak lulus pada\n campaign ini"
                          : status_apply == "Menunggu Persetujuan"
                              ? "Campaign ini sedang\n menunggu persetujuan brand"
                              : "Anda tidak mendaftar pada\n campaign ini",
                      textAlign: TextAlign.center,
        ...
        : SingleChildScrollView(
            child: Column(children: [
              Container(
                ...
                child: Text(
                    "Let's complete the report's steps to\n finish your campaign",
                    textAlign: TextAlign.center,
                    style: TextStyle(
                        fontSize: 15, height: 2, color: Colors.black45)),
              ),
              Container(
