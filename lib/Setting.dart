...
class _Setting extends State<Setting>with AutomaticKeepAliveClientMixin<Setting> {
  @override
 ...
 String logout="http://36.37.120.131/iam-mobile/api/influencer/auth/logout";
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          centerTitle: true,
          title:Text("Settings",style:TextStyle(fontWeight:FontWeight.bold,fontSize: size.width/22)),
        ...
        body:Container(margin:EdgeInsets.only(left: 40,right: 40),child: Column(
            children:[
              ...
              Container(
                  ...
                  children: [
                      Container(height: 30,child: Image.asset('assets/contactus.png')),
                      SizedBox(width:20,),
                      Text("Contact Us", style: TextStyle(fontSize: 17,color: Colors.black87),),],
                  ),)
              ),
              InkWell(onTap:(){
                Navigator.push(context, CupertinoPageRoute( builder: (context) => Term(), ));
              },
              child: Container(
               ...
               child:Row(
                 crossAxisAlignment: CrossAxisAlignment.center,
                children: [
                 Text("Term and Conditions", style: TextStyle(fontSize: 17,color: Colors.black87),),],
                   )
              ),),

              InkWell(onTap:(){
                Navigator.push(context, CupertinoPageRoute( builder: (context) => privacy(), ));
              },
                child: Container(
                    ...
                    child:Row(
                      crossAxisAlignment: CrossAxisAlignment.center,
                      children: [
                        Text("Privacy Policy", style: TextStyle(fontSize: 17,color: Colors.black87),),],
                    )
                ),),
              SizedBox(height: 25),
                    ...
                    //Encode the url
                      Uri.encodeFull(logout)).then((response) {
                        if(response.statusCode==200){
                          google_signOut();facebook_logout();}
                  });
        ...
        child:Row(
          crossAxisAlignment: CrossAxisAlignment.center,
          children: [
            Container(height: 30,child: Image.asset('assets/logout.png')),
            SizedBox(width:20,),
            Text("Logout", style: TextStyle(fontSize: 17,color: Colors.black87),),],
        )
    ),
              )
