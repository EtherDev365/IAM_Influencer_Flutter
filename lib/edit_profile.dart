...
class _edit_profile extends State<edit_profile> {
  ...
  String editprofile_url =
      "https://web.iam.id/iam-mobile/api/influencer/profile-settings";
  ...
  Future<String> getJsonData_kota(String url, int id_provinsi) async {
    ...
    http.post(Uri.encodeFull(url), body: {
      ...
      for (int i = 0; i < data_kota_edit.length; i++) {
        editkkota.add(data_kota_edit[i]['name']);
      }
      setState(() {
            ...
            child: ListView(
              ...
              children: [
                ...
                Row(children: [
                  SizedBox(width: size.width / 10),
                  Text(
                    "Tempat kerja/Sekolah/Universitas",
                    style: TextStyle(
                        fontStyle: FontStyle.normal,
                        fontSize: size.height / 50,
                        color: Colors.black87),
                              ...
                              setState(() {
                                ...
                                currentSelectedprovinsi_id = int.parse(
                                    data_provinsi[provinsi
                                            .indexOf(currentSelectedprovinsi)]
                                        ['id_provinsi']);
                          ...
                          child: DropdownButton<String>(
                            ...
                            onChanged: (newValue) {
                              setState(() {
                                ...
                                currentSelectedcity_id = data_kota_edit[
                                        kota_edit_profile.indexOf(newValue)]
                                    ['id_kota'];
                              });
                            },
                    ...
                    InkWell(
                      onTap: () {
                        ...
                        if (_formKey.currentState.validate()) {
                          http.post(Uri.encodeFull(editprofile_url), headers: {
                            ...
                            "id_provinsi":
                                currentSelectedprovinsi_id.toString(),
