    ...
    setState(() {
      ...
      if (data_upcoming != null) {
        if ((5 >= data_upcoming.length)) {
          ...
          items_upcoming.clear();
          items_upcoming.addAll(data_upcoming.getRange(0, 5));
          present_upcoming = 5;
        }
      }
    });
        ...
        ? Stack(
            children: [
              new ListView.builder(
                  itemCount: (present_upcoming < data_upcoming.length)
                      ? items_upcoming.length + 1
                      : items_upcoming.length,
                  itemBuilder: (BuildContext context, int index) {
                    return ((index == items_upcoming.length) &&
                            (index != data_upcoming.length))
                        ? InkWell(
                            child: Container(
                            ...
                            onTap: () {
                              setState(() {
                                if ((present_upcoming + perPage_upcoming) >
                                    data_upcoming.length) {
                                  items_upcoming.addAll(data_upcoming.getRange(
                                      present_upcoming, data_upcoming.length));
                                } else {
                                  items_upcoming.addAll(data_upcoming.getRange(
                                      present_upcoming,
                                      present_upcoming + perPage_upcoming));
                                }
                                present_upcoming =
                                    present_upcoming + perPage_upcoming;
                              });
            ...
            child: Column(
              children: [
                ...
                Container(
                  ...
                  child: Text("Campaign Upcoming Tidak Tersedia",
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: InkWell(
                        onTap: () {
                          setState(() {
                            if (data_saved_id.contains(data_upcoming[index]
                                    ['id_campaign']
                                .toString())) {
                              http.post(Uri.encodeFull(delete_url), headers: {
                                HttpHeaders.authorizationHeader: 'Bearer $token'
                              }, body: {
                                "id_campaign": data_upcoming[index]
                                        ['id_campaign']
                                    .toString(),
                              }).then((response) {
                                print(response.body);
                        ...
                        child: Image.asset(
                          ...
                          color: (loged == true)
                              ? (data_saved_id.contains((data_upcoming[index]
                                          ['id_campaign']
                                      .toString()))
                                  ? kSelectedLabelColor
                                  : kBackgoundColor)
                  ...
                  child: Column(
                    children: [
                      Container(
                        ...
                        child: Text(
                          data_upcoming[index]['release_date'] == null
                              ? data_upcoming[index]['countdown'] != null
                                  ? data_upcoming[index]['countdown'].toString()
                                  : ""
                              : data_upcoming[index]['release_date'].toString(),
                          style:
                          ...
                          children: [
                            Row(
                              ...
                              children: [
                                Flexible(
                                    child: Text(
                                  data_upcoming[index]['hashtag'] != null
                                      ? data_upcoming[index]['hashtag']
                                          .toString()
                                      : "",
                                  style: TextStyle(
                                ...
                                Text(
                                  data_upcoming[index]['price'] != null
                                      ? data_upcoming[index]['price'].toString()
                                      : "",
                                  style: TextStyle(
                            ...
                            Text(
                              items_upcoming[index]['niche'].toString() +
                                  " - " +
                                  data_upcoming[index]['gender'].toString(),
                              style: TextStyle(
                                  color: kTextThemColor1, fontSize: 12.0),
                            ),
                          ],
