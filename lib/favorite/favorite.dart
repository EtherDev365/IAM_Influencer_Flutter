...
class _favorite extends State<favorite>
    with AutomaticKeepAliveClientMixin<favorite> {
  @override
    ...
    setState(() {
      if (data_mycampaigns_favorite != null) {
        if ((5 >= data_mycampaigns_favorite.length)) {
          mycampaigns_favorite_items.clear();
          mycampaigns_favorite_items.addAll(data_mycampaigns_favorite);
          mycampaigns_favorite_present = data_mycampaigns_favorite.length;
        } else {
          mycampaigns_favorite_items.clear();
          mycampaigns_favorite_items
              .addAll(data_mycampaigns_favorite.getRange(0, 5));
  ...
  Widget build(BuildContext context) {
    ...
    return data_mycampaigns_favorite != null
        ? Stack(
            children: [
              new ListView.builder(
                  itemCount: (mycampaigns_favorite_present <
                          data_mycampaigns_favorite.length)
                      ? mycampaigns_favorite_items.length + 1
                      : mycampaigns_favorite_items.length,
                  itemBuilder: (BuildContext context, int index) {
                    return ((index == mycampaigns_favorite_items.length) &&
                            (index != data_mycampaigns_favorite.length))
                        ? InkWell(
                            child: Container(
                            ...
                            onTap: () {
                              setState(() {
                                if ((mycampaigns_favorite_present +
                                        mycampaigns_favorite_perPage) >
                                    data_mycampaigns_favorite.length) {
                                  mycampaigns_favorite_items.addAll(
                                      data_mycampaigns_favorite.getRange(
            ...
            child: Column(
              children: [
                ...
                Container(
                  ...
                  child: Text("Belum Ada Campaign Favorite",
                  ...
                  children: [
                    LayoutBuilder(
                      builder: (context, constraint) {
                        if (data_mycampaigns_favorite[index]
                                ['premium_campaign'] ==
                            0) {
                          return Container();
                        } else {
                        ...
                        onTap: () {
                          setState(() {
                            if (data_saved_id.contains(
                                data_mycampaigns_favorite[index]['id_campaign']
                                    .toString())) {
                              http.post(Uri.encodeFull(delete_url), headers: {
                                HttpHeaders.authorizationHeader: 'Bearer $token'
                              }, body: {
                                "id_campaign": data_mycampaigns_favorite[index]
                                        ['id_campaign']
                                    .toString(),
                              }).then((response) {
                                print(response.body);
                        ...
                        child: Image.asset(
                          ...
                          color: (loged == true)
                              ? (data_saved_id.contains(
                                      (data_mycampaigns_favorite[index]
                                              ['id_campaign']
                                          .toString()))
                                  ? kSelectedLabelColor
                                  : kBackgoundColor)
                  ...
                  child: Column(
                    children: [
                      Container(
                        ...
                        child: Text(
                          data_mycampaigns_favorite[index]['countdown']
                              .toString(),
                          style:
                          ...
                          children: [
                            Row(
                              ...
                              children: [
                                Flexible(
                                    child: Text(
                                  data_mycampaigns_favorite[index]['hashtag'] !=
                                          null
                                      ? data_mycampaigns_favorite[index]
                                              ['hashtag']
                                          .toString()
                                ...
                                Text(
                                  data_mycampaigns_favorite[index]['price'] !=
                                          null
                                      ? data_mycampaigns_favorite[index]
                                              ['price']
                                          .toString()
                            ...
                            Text(
                              data_mycampaigns_favorite[index]['campaign_name']
                                  .toString(),
                              style: TextStyle(
                            ...
                            Text(
                              data_mycampaigns_favorite[index]['niche']
                                      .toString() +
                                  " - " +
                                  data_mycampaigns_favorite[index]['gender']
                                      .toString(),
                              style: TextStyle(
                                  color: kTextThemColor1, fontSize: 12.0),
                            ),
