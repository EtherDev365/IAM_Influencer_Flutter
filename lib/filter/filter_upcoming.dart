...
class _Filter_upcoming extends State<Filter_upcoming>with AutomaticKeepAliveClientMixin<Filter_upcoming> {
  @override
        ...
        appBar: AppBar(
          ...
          actions: [
            Container(
              ...
              child:InkWell(child:Text("Clear",style:TextStyle(fontWeight:FontWeight.bold,fontSize: size.width/22),),onTap: (){setState((){upcoming_selectedChoices_state.clear();upcoming_selectedChoices_gender.clear();upcoming_selectedChoices_category.clear();starValue=0;endValue=0;startController.text=starValue.toString();endController.text=endValue.toString();});}),)
          ],
        ),
                  ...
                  child: Container(
                      ...
                      child: InkWell(child:Center(child:Text("Save",style: TextStyle(color:Colors.white,fontSize:  size.height/40,)),),onTap: (){
                        ...
                        http.post(filter_url, body: {
                          "status":(upcoming_selectedReportList_status.length==0)?"":upcoming_selectedReportList_status.reduce((value, element) => value + ',' + element),
                          "category":(upcoming_selectedReportList_category.length==0)?"":upcoming_selectedReportList_category.reduce((value, element) => value + ',' + element),
                          "gender": (upcoming_selectedReportList_gender.length==0)?"":upcoming_selectedReportList_gender.reduce((value, element) => value + ',' + element),
  ...
  _buildChoiceList() {
    ...
    widget.reportList.forEach((item) {
      choices.add(Container(
        ...
        child: ChoiceChip(
          padding: const EdgeInsets.only(top:6.0,bottom: 6,left: 10,right: 10),
          label: Text(item,style: TextStyle(fontSize: 16,color:upcoming_selectedChoices_state.contains(item)
              ?Colors.white:Colors.black38 ),),
          ...
          onSelected: (selected) {
            setState(() {
              ...
              widget.onSelectionChanged(upcoming_selectedChoices_state); // +added
            });
          },
        ),
      ));
  ...
  _buildChoiceList() {
    ...
    widget.reportList.forEach((item) {
      choices.add(Container(
        ...
        child: ChoiceChip(
          padding: const EdgeInsets.only(top:6.0,bottom: 6,left: 10,right: 10),
          label: Text(item,style: TextStyle(fontSize: 16,color:upcoming_selectedChoices_category.contains(item)
              ?Colors.white:Colors.black38 ),),
          ...
          onSelected: (selected) {
            setState(() {
              ...
              widget.onSelectionChanged(upcoming_selectedChoices_category); // +added
            });
          },
        ),
      ));
  ...
  _buildChoiceList() {
    ...
    widget.reportList.forEach((item) {
      choices.add(Container(
        ...
        child: ChoiceChip(
          padding: const EdgeInsets.only(top:6.0,bottom: 6,left: 10,right: 10),
          label: Text(item,style: TextStyle(fontSize: 16,color:upcoming_selectedChoices_gender.contains(item)
              ?Colors.white:Colors.black38 ),),
          ...
          onSelected: (selected) {
            setState(() {
              ...
              widget.onSelectionChanged(upcoming_selectedChoices_gender); // +added
            });
          },
        ),
      ));
